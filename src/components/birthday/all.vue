...
const countDown = () => {
  ...
  sec.value =
    Math.floor(remain / 1000) % 60 >= 10
      ? Math.floor(remain / 1000) % 60
      : `0${Math.floor(remain / 1000) % 60}`
  min.value =
...
<template>
  <div class="relative w-full h-[460px] pt-[75px] pl-[4vw]">
    ...
    <div class="absolute top-0 right-[6vw] z-[1]">
      <img src="@/assets/icon/egg-kv.png" alt="" class="w-[33vw] h-auto" />
    </div>
    <div class="w-[7vw] h-[7vw] rounded-full bg-[#ffefad] relative">
      <div class="text-[#333333] font-medium absolute left-1/2 top-0 w-[30vw]">
        ...
        <p class="text-[noto-sans-TC] font-[300] text-base">
