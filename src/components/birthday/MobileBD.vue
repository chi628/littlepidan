...
<template>
  <div class="w-full h-[625px]">
    ...
    <div class="w-[90vw] absolute top-[150px]">
      ...
      <p class="text-sm font-normal font-noto-sans-TC absolute top-[265px] left-7">
        我是歐又禎，也可以叫我歐小蛋<br />我要滿一歲了！
      </p>
    </div>
    <div class="bg2">
      <div class="w-[10px] h-[10px] rounded-full bg-white absolute top-[104px] left-2"></div>
      <div class="w-6 h-6 rounded-full bg-[#ffd0de] absolute top-10 right-8"></div>
    </div>
  </div>
</template>
<style lang="scss">
...
.bg2 {
  ...
  @apply bg-center bg-no-repeat bg-cover w-[100vw] h-[108vw] absolute top-[400px] -right-[80px] z-[3];
}
</style>
