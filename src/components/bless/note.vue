...
<template>
  <div class="w-[160px] sm:w-[220px] h-[182px] relative">
    ...
    ></div>
    <div
      class="w-[140px] sm:w-[200px] h-[160px] -rotate-[6deg] shadow-md"
      :style="Bg2Style"
    ></div>
    <div
      class="w-[140px] sm:w-[200px] h-[160px] bg-[#fff2dd] absolute top-0 shadow-md"
    ></div>
    ...
    <div
      class="absolute top-0 w-[140px] sm:w-[200px] h-[155px] px-2 pb-2 pt-[30px] ellipsis-5 text-[#333333] font-[100] font-chen text-[24px] text-center"
    >
      {{ $props.content }}
    </div>
  </div>
