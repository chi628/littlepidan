...
<template>
  <div class="w-full h-[962px] bg-cloud-pc relative lg:pt-[50px] xl:pt-[138px]">
    <div class="lg:w-[50vw] xl:w-[40vw] h-auto mx-auto">
      <img src="@/assets/title/tt-365.png" alt="" class="w-full h-auto" />
    </div>
    <div class="">
      <img
        ...
        <div class="absolute w-full h-full top-0 left-0 perspective">
          ...
          >
            ...
            <div class="w-full h-full py-[2.5%] px-[5%] z-[2] relative">
              <p
                class="text-[#333333] text-xs inline-flex justify-around items-center w-full"
              >
                歐小蛋成長日記
                <span
              ...
              <div class="w-full h-[90%] grid grid-cols-2 gap-2">
          ...
          <div class="absolute top-0 right-0 w-1/2 h-full bg-white">
            ...
            <div class="w-full h-full py-[2.5%] px-[5%] absolute right-0">
              <div class="w-full h-[95%] grid grid-cols-2 gap-x-2 gap-y-8">
